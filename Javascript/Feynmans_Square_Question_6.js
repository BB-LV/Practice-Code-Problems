...
/* Strategy:
    This question is a simple question worded in a fun way. The actual question being solved is a pattern in the numbers where
    you are finding the sum of the input number squared and every positive number below it squared.
    a for loop and a counter are an easy way to achieve this without manipulating the input number.
*/
...
// We can clean the above for loop up with a recursive arrow function

let countSquares = n => n > 1 ? n * n + countSquares(n - 1) : n;
