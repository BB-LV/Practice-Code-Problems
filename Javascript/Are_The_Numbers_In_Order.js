...
This kata is giving us a single array as an argument and asking us to return a boolean
value of true/false representing if the input array is in order of least to greatest.

To achieve this we can run a for loop comparing the first index of the array
to the index directly in front of it, if the index in front is less than the 
current index of the loop, than the input array is not in order.
*/
